...
# Build ausfuehren
Write-Host "`nTypeScript kompilieren..." -ForegroundColor Yellow
...
# Dateien fuer Deployment vorbereiten
$deployFiles = @(
    "dist",
    "views", 
    "css",
...
Write-Host "`nDateien uebertragen..." -ForegroundColor Yellow
...
foreach ($file in $deployFiles) {
    if (Test-Path $file) {
        ...
        Write-Host "  $file nicht gefunden, ueberspringe..." -ForegroundColor Yellow
    }
}

Write-Host "`nRemote-Setup ausfuehren..." -ForegroundColor Yellow

# Fuehre Remote-Befehle direkt aus
...
# PM2 pruefen und neu starten
Write-Host "  PM2: Pruefe Status..."
