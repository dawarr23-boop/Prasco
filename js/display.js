...
async function showLiveDataWidget() {
  ...
  if (headerCategory) {
    headerCategory.innerHTML = `<div style="background: #009640; color: white; padding: 0.6rem 1.2rem; border-radius: 20px; font-size: 0.88rem; font-weight: 700; box-shadow: 0 2px 8px rgba(0,150,64,0.25); letter-spacing: 0.02em;">◉ Live-Daten</div>`;
  }
